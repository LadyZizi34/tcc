...
extern "C" {
#endif
    struct sensordata; // a nice opaque type

    struct sensordata *sensordata_create();
    struct sensordata *sensordata_create_init(int sequence_number, 
                                              Attitude attitude_type,
                                              ...
                                              ImuData<int> imu_rawdata,
                                              ImuData<float> imu)                                        );
    void           sensordata_destroy(struct sensordata *a);

    void           sensordata_setage(struct sensordata *a, int new_age);
    void           sensordata_setheight(struct sensordata *a, float new_height);
    int            sensordata_getage(struct sensordata *a);
    float          sensordata_getheight(struct sensordata *a);
#ifdef __cplusplus
}
#endif
